package com.yeonsung.aaa.mobileproject_0506_2;
...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener btnListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            int edit2Num = Integer.parseInt(edit2Str);
            int result = 0;

            switch (view.getId()){
                case R.id.btn_plus: result=edit1Num+edit2Num;
                    break;
                case R.id.btn_minus: result=edit1Num-edit2Num;
                    break;
                case R.id.btn_multi: result=edit1Num*edit2Num;
                    break;
                case R.id.btn_divide: result=edit1Num/edit2Num;
                    break;
            }
